...
class HelpWindow:
    def __init__(self, parent):
        ...
        self.helpWindow.place_window_center()
        ...
        helpNotebook = Notebook(helpFrame, bootstyle="info")
        helpNotebook.grid(column = 0, row = 1, sticky = NSEW)
        helpButton = Button(helpFrame, name = "help", text = "More Help", padding=5, command=self.openSite, bootstyle="info")
        helpButton.grid(column = 0, row = 2, sticky=(EW))

        loginFrame = ScrolledFrame(helpNotebook, padding = 5, relief = SOLID)
        helpNotebook.add(loginFrame.container, text = "Logging In")
        lfmFrame = ScrolledFrame(helpNotebook, padding = 5, relief = SOLID)
        helpNotebook.add(lfmFrame.container, text = "Last.fm Features")
        plistFrame = ScrolledFrame(helpNotebook, padding = 5, relief = SOLID)
        helpNotebook.add(plistFrame.container, text = "Playlist Creation")
        exportFrame = ScrolledFrame(helpNotebook, padding = 5, relief = SOLID)
        helpNotebook.add(exportFrame.container, text = "Exporting to Spotify")
        moreFrame = ScrolledFrame(helpNotebook, padding = 5, relief = SOLID)
        helpNotebook.add(moreFrame.container, text = "More")
    ...
    def configLoginFrame(self, loginFrame: Frame):
        ...
        loginGeneralHelpLabel.configure(wraplength=self.helpWindow.winfo_width()-45)
        ...
        loginLfmHelpLabel.configure(wraplength=self.helpWindow.winfo_width()-45)
        loginLfmHelpButton = Button(loginFrame, text = "Last.fm Website", command=self.openLastfm, bootstyle="danger")
        loginLfmHelpButton.grid(column = 0, row = 5, pady=5, sticky = EW)
        ...
        loginSpotifyHelpLabel.configure(wraplength=self.helpWindow.winfo_width()-45)
        loginSpotifyHelpButton = Button(loginFrame, text = "Spotify Dev Dash", command=self.openSpotifyDev, bootstyle="success")
        loginSpotifyHelpButton.grid(column = 0, row = 9, pady=5, sticky = EW)
    ...
    def configLfmFrame(self, lfmFrame: Frame):
        ...
        lfmGeneralHelpLabel.configure(wraplength=self.helpWindow.winfo_width()-45)
        ...
        lfmTSDTHelpLabel.configure(wraplength=self.helpWindow.winfo_width()-45)
        ...
        lfmGRSHelpLabel.configure(wraplength=self.helpWindow.winfo_width()-45)
    ...
    def configPlistFrame(self, plistFrame: Frame):
        ...
        plistGeneralHelpLabel.configure(wraplength=self.helpWindow.winfo_width()-45)
        ...
        plistSelectionHelpLabel.configure(wraplength=self.helpWindow.winfo_width()-45)
        ...
        plistAdditionHelpLabel.configure(wraplength=self.helpWindow.winfo_width()-45)
        ...
        plistDuplicateHelpLabel.configure(wraplength=self.helpWindow.winfo_width()-45)
    ...
    def configExportFrame(self, exportFrame: Frame):
        ...
        exportGeneralHelpLabel.configure(wraplength=self.helpWindow.winfo_width()-45)
        ...
        exportCreationHelpLabel.configure(wraplength=self.helpWindow.winfo_width()-45)
        ...
        exportImageHelpLabel.configure(wraplength=self.helpWindow.winfo_width()-45)
    ...
    def configMoreFrame(self, moreFrame: Frame):
        ...
        moreHelpLabel.configure(wraplength=self.helpWindow.winfo_width()-45)