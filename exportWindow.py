...
class ExportWindow:
    def __init__(self, songList: str, parent):
        ...
        self.exportWindow.geometry("450x650")
        ...
        self.playlistNewNameInput.grid(column = 0, row = 3, sticky = EW, columnspan = 3, pady=5)
        self.playlistDescLabel.grid(column = 0, row = 4, sticky = EW, pady=5)
        self.playlistDescText.grid(column = 0, row = 5, sticky = EW, columnspan = 3, pady=5)
        self.playlistDescScrollbar.grid(column = 3, row = 5, sticky = (W, NS), pady=5)
        ...
        self.exportProgressbar = Progressbar(exportProgressFrame, orient=HORIZONTAL, length=300, mode='determinate', maximum = len(self.songList))
        ...
        cancelExportButton = Button(buttonFrame, name = "cancel", text = "Cancel", padding=5, style="R.TButton", command=self.closeWindow)
        confirmExportButton = Button(buttonFrame, name = "confirm", text = "Confirm and Export", padding=5, style="G.TButton", command=self.exportPlaylist)
    ...
    def exportPlaylist(self):
        ...
        if self.playlistNameVar.get() == "":
            ...
            return
        self.exportProgressbar.grid(column = 0, row = 1, sticky = EW)
        self.addSong()
    ...
    def renderNew(self):
        ...
        self.playlistNewNameLabel.grid(column = 0, row = 2, sticky = EW, columnspan = 4)
        self.playlistNewNameInput.grid(column = 0, row = 3, sticky = EW, columnspan = 4)
        self.playlistDescLabel.grid(column = 0, row = 4, sticky = EW)
        self.playlistDescText.grid(column = 0, row = 5, sticky = EW)
        self.playlistDescScrollbar.grid(column = 1, row = 5, sticky = NS)
